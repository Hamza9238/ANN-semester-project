...
from helpers import ensure_directory, print_step_header
...
def build_dataset(
    ...
    """
    print_step_header(3, "DATASET BUILDING")
    ...
    for ticker in tickers:
        ...
        if save_data:
            data_dir = ensure_directory(os.path.join(os.path.dirname(__file__), "data"))
